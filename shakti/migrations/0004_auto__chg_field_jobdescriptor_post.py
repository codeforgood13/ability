...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobDescriptor.post'
        db.alter_column(u'shakti_jobdescriptor', 'post', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'JobDescriptor.post'
        db.alter_column(u'shakti_jobdescriptor', 'post', self.gf('django.db.models.fields.CharField')(max_length=10))
